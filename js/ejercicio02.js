...
var fullnameOwner="Yhostin M. Ramirez gonzalez";
let nameProperty="Hermosa casa en la playa de puerto vallarta";
let descriptionProperty="Casa de 2 piso, 4 hanitaciones, 2 baños completos y estacionamiento para 2 automoviles a orillla del mar.";
var estatus="Disponible";
const tipo="C";
var addressProperty;
/*los tipos de datos string son unas palbaras , valores cualitativos de las entidades de nuestra aplicacion , que no tienennun tamaño maximo
 y que estan confromadas por caractere -- de nuestra  aplicacion que no tienen un tamaño maximo y que es-- alfabeticos, 
 caradcteres especiales como acentos o simbolos de alguna--*/
console.warn("4. STRING(cadena de caracteres, palabras)");
console.long(`El usuario:${fullnameOwner},
    ...
    console.log(`Las variables declaradas son del tipo:
        fullnamerOwer: ${typeof(fullnameOwner) }
        nameProperty:${typeof(nameProperty) }
        descriptiionProperty: ${typeof(descriptionProperty) }
